...
class FeeCalculator:
    ...
    # Tiered fee structure based on contract price (in cents)
    # Fees are highest for contracts priced near 50¢ and decrease toward extremes
    # Note: These rates are approximations - actual fees may vary by market conditions
    FEE_SCHEDULE = {
    ...
    # Maker orders (limit orders that add liquidity) receive 50% fee discount
    MAKER_FEE_MULTIPLIER = 0.5  # Makers pay 50% of standard taker fees
